...
require_relative "../../../app/services/bitbucket_hook/message_logger"
...
class MessageLoggerTest < Minitest::Test
  ...
  def test_logs_to_a_wrapped_logger_as_well
    wrapped_logger = BitbucketHook::MessageLogger.new
    logger = BitbucketHook::MessageLogger.new(wrapped_logger)
